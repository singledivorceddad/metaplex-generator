      ...
      <Html lang="en">
        <Head>
          ...
          <link
            ...
            type="image/png"
            sizes="32x32"
            href="metaplex-generator/favicon-32x32.png"
          />
          <link
            rel="icon"
            type="image/png"
            sizes="96x96"
            href="metaplex-generator/favicon-96x96.png"
          />
          <link
            rel="icon"
            type="image/png"
            sizes="16x16"
            href="metaplex-generator/favicon-16x16.png"
          />
          <meta name="theme-color" content="#000000" />
          <meta name="description" content="NFT Generator Marketplace" />
          <link rel="manifest" href="metaplex-generator/manifest.json" />
          <link
            rel="stylesheet"
